...
<div class="topbar"><div class="container topbar__inner">
  ...
  <div class="topbar__social">
    <a href="ogrenci-giris.html" style="opacity:1;color:var(--amber);font-weight:600;gap:6px" aria-label="Öğrenci Girişi"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg> Öğrenci Girişi</a>
    <span style="width:1px;height:14px;background:var(--line-2)"></span>
...
<aside class="mobile-nav" id="mobileNav" aria-label="Mobil menü">
  ...
  <ul>
    <li><a href="index.html#hakkimizda">Hakkımızda</a></li><li><a href="vizyonumuz.html">Vizyonumuz</a></li><li><a href="gsf-hazirlik.html">GSF Hazırlık</a></li><li><a href="workshoplar.html">Workshoplar</a></li><li><a href="yurt-disi-portfolyo.html">Portfolyo</a></li><li><a href="cikmis-sorular.html">Çıkmış Sorular</a></li><li><a href="blog.html">Blog</a></li><li><a href="yetenek-testi.html">Yetenek Testi</a></li><li><a href="ogrenci-giris.html">Öğrenci Girişi</a></li><li><a href="index.html#iletisim">İletişim</a></li>
  </ul>
...
<footer class="footer"><div class="container">
  <div class="footer__grid">
    ...
    <div><h4>Kurumsal</h4><ul><li><a href="index.html#hakkimizda">Hakkımızda</a></li><li><a href="vizyonumuz.html">Vizyonumuz</a></li><li><a href="blog.html">Blog</a></li><li><a href="cikmis-sorular.html">Çıkmış Sorular</a></li><li><a href="yetenek-testi.html">Yetenek Testi</a></li><li><a href="kvkk-aydinlatma.html">KVKK Aydınlatma</a></li><li><a href="index.html#iletisim">İletişim</a></li></ul></div>
...
<a class="wa-float" href="https://wa.me/905425983374?text=${encodeURIComponent('Merhaba, bilgi almak istiyorum.')}" target="_blank" rel="noopener" aria-label="WhatsApp ile yazın"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.5 14.4c-.3-.15-1.77-.87-2.04-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.95 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.48-.9-.8-1.5-1.77-1.67-2.07-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.62-.92-2.22-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.49 0 1.47 1.07 2.89 1.22 3.09.15.2 2.1 3.2 5.08 4.49.71.31 1.26.49 1.69.62.71.23 1.36.2 1.87.12.57-.09 1.77-.72 2.02-1.42.25-.7.25-1.3.17-1.42-.07-.13-.27-.2-.57-.35zM12 2a10 10 0 0 0-8.5 15.3L2 22l4.8-1.5A10 10 0 1 0 12 2z"/></svg></a>
